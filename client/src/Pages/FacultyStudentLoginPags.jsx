                            ...
                            <div>
                                ...
                                <form noValidate onSubmit={facultyFormHandler}>
                                    <div className="form-group">
                                        <label className='h5' htmlFor="facRegId">Registration Number</label>
                                    ...
                                    <div className="form-group">
                                        <label className='h5' htmlFor="passwordFacId">Password</label>
                                    ...
                                    {!isFacultyLoading && <button type="submit" className="btn btn-info updatebtn btn-block">Login</button>}
                                </form>
                        ...
                        <div className="col-md-8 m-auto border" style={{ backgroundColor: "white", borderRadius: "1.2rem", padding: "1rem 1rem 0rem 1rem" }}>
                            <div>
                                ...
                                <form noValidate onSubmit={studentFormHandler}>
                                    <div className="form-group">
                                        <label className='h5' htmlFor="studentId">Registration Number</label>
                                    ...
                                    {!isStudentLoading && <button type="submit" className="btn btn-info btn-block updatebtn ">Login</button>}
