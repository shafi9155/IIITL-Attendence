            ...
            {store.admin.isAuthenticated ? (<><AdminHomeHelper />
                <div className="div1">
                    <div className="row row1 ">
                        <div className="col">
                        <h1   className='heading text-center m-auto pb-5'> ADD ADMIN</h1>
                            <form noValidate onSubmit={formHandler}>
                                <div className="row">
                                    <div className="col-md-8">
                                        <div className="form-group">
                                            <label className='h5' htmlFor="nameId">Admin Name</label>
                                    ...
                                    {!isLoading && <button type="submit" className="btn btn-info updatebtn ">Add Admin</button>}
                            </form>
                        </div>
                    </div>
                </div></>) : (history.push('/'))}
