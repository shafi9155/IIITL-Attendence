            ...
            {store.admin.isAuthenticated ? <> <AdminHomeHelper />
                <div className="div1">
                    <div className="row justify-content-center row1">
                        ...
                        <h1   className='heading text-center m-auto pb-5'> ADD SUBJECT</h1>
                                <form noValidate onSubmit={formHandler}>
                                    <div className="form-group">
                                        <label  className='h5' htmlFor="snameId">Subject Name</label>
                                    ...
                                    <div className="form-group">
                                        <label  className='h5' htmlFor="scodeId">Subject Code</label>
                                    ...
                                    <div className="form-group">
                                        <label className='h5' htmlFor="totalLectures">Total Lectures</label>
                                    ...
                                    {!isLoading && <button type="submit" className="btn btn-info updatebtn ">Add Subject</button>}
