    ...
    return (
        <div>
            {store.faculty.isAuthenticated ? <>
                <FacultyHomeHelper />
                <div className="div1">
                {store.faculty.fetchedStudentsHelper && <div className="row  row1">
                    <div className="col-md-4">
                    <h1   className='heading text-center  h2 m-auto pb-5'>MARK ATTENDENCE</h1>
                        <form noValidate onSubmit={formHandler}>
                            <div className="form-group">
                                <label  className='h5' htmlFor="branchId">Department</label>
                            ...
                            <div className="form-group">
                                <label className='h5' htmlFor="yearId">Year</label>
                            ...
                            <div className="form-group">
                                <label className='h5' htmlFor="sectionId">Section</label>
                            ...
                            {!isLoading && <button type="submit" className="btn btn-info  updatebtn">Search</button>}
                        </form>
                    </div>
                 ...
                 <div class="div1">
                {!store.faculty.fetchedStudentsHelper && <div className="row  justify-content-center mt-4 row1">
                    <div className="col-md-4">
                    <h1   className='heading text-center  h2 m-auto pb-5'>MARK ATTENDENCE</h1>
                        <form onSubmit={secondFormHandler}>
                            <div className="form-group">
                                <label  className='h5' htmlFor="subjectId">Subject Code</label>
                                ...
                                <tbody>
                                    {
                                        store.faculty.fetchedStudents.map((obj, index) =>
                                            <tr>
                                                <td><div className="form-check checkbox-xl">
                                                    <input className="form-check-input" type="checkbox" value={obj._id} onChange={handleInputChange} id="defaultCheck1" />
                                                </div></td>
                                                <td className='h4' key={index}>{obj.registrationNumber}</td>
                                                <td className='h4'>{obj.name}</td>
                                            </tr>
                                        )
                                    }
                                </tbody>
                            ...
                            {!isLoading2 && <button type="submit" className="btn btn-info ml-1 updatebtn  ">Submit</button>}
                        </form>
                    </div>
                </div>
                }</div></> : (history.push('/'))}
